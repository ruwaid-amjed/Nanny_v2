    ...
    <script>
        ...
        function handleSelectionSignup(selectedRole) {
            if (selectedRole === 'عائلة') {
                ...
                window.location.href = '../sitterSignup/sitterSignupGenral.php?role=' + encodeURIComponent(selectedRole);
            }
        }
    </script>
...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="page">
                ...
                <h1>اهلا بك في Nanny</h1>
                <span>هل لديك حساب بالفعل؟ <a href="../login/login.php" style="font-weight:bold;">تسجيل دخول </a></span>
            </div>
            <div class="myForm">
                <form action="signupuser2.php" method="post" auto_complete="off" id="signupForm">
                   ...
                   <div class="link">
                    <p>تريد ان تصبح جليسه اطفال ؟ <a href="../sitterSignup/sitterSignUpGenral.php?role=مربية"> اشترك كجليسه اطفال</a></p>
                   </div>
    ...
    <footer class="site-footer">
        <div class="footer-container">
            ...
            <div class="social-icons">
                <a href="" class="social-icon" aria-label="Facebook"><img src="imgs/facebook-removebg-preview.png"
                        alt=""></a>
                <a href="" class="social-icon" aria-label="Twitter"><img src="imgs/twitter-removebg-preview.png"
                        alt=""></a>
                <a href="" class="social-icon" aria-label="Instagram"><img src="imgs/instgram-removebg-preview.png"
                        alt=""></a>
            </div>
            <div class="copyright">
    ...
    <script>
        async function checkEmailAndPhone() {
            ...
            const response = await fetch('emailPhoneCheck.php', {
                method: 'POST',
                headers: {
